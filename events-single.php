                    ...
                    <div class="widget widget-feature">
                        ...
                        <div class="widget-body">
                            ...
                            ?>
                                <ul>
                                    <li>
                                        <div class="ques cl-i-one"><i class="fas fa-calendar"></i>Date de début</div>
                                        <div class="ans"><?php echo date('d/m/Y', strtotime($row['start_date'])); ?></div>
                                    </li>
                                    <li>
                                        <div class="ques cl-i-two"><i class="fas fa-clock"></i>Heure de début</div>
                                        <div class="ans"><?php echo $row['start_time']; ?></div>
                                    </li>
                                    <li>
                                        <div class="ques cl-i-three"><i class="fas fa-calendar"></i>Date de fin</div>
                                        <div class="ans"><?php echo date('d/m/Y', strtotime($row['end_date'])); ?></div>
                                    </li>
                                    <li>
                                        <div class="ques cl-i-four"><i class="fas fa-clock"></i>Heure de fin</div>
                                        <div class="ans"><?php echo $row['end_time']; ?></div>
                                    </li>
                                    <li>
                                        <div class="ques cl-i-five"><i class="fas fa-home"></i>Emplacement</div>
